 ...
 ************************/
int storm_opendb(char *db_srvr, char *db_user, char *db_pwd, struct srm_dbfd *dbfd)
{               
...
storm_closedb(struct srm_dbfd *dbfd)
{
 ...
 *************************/
int storm_start_tr(int s, struct srm_dbfd *dbfd)
{
...
int storm_end_tr(struct srm_dbfd *dbfd)
{
...
storm_abort_tr(struct srm_dbfd *dbfd)
{
...
int storm_exec_query(const char * const func, struct srm_dbfd *dbfd, const char *sql_stmt, MYSQL_RES **res)
{
...
*/
int free_storm_req_transfer_params(struct storm_req *request)
{
    int i;
    if(NULL == request)
        return EINVAL;
...
void free_gfr_entry_array(struct storm_get_filereq **gfr_array)
{
    int i;
    if(NULL == gfr_array)
        return;
 ...
 * request should be not-NULL. request->protocols can be NULL.
*/
int free_storm_req(struct storm_req *request)
{
...
void storm_decode_pfr_entry(MYSQL_ROW row,
...
void storm_decode_xferreq_entry(MYSQL_ROW row, int lock, storm_dbrec_addr *rec_addr, struct storm_req *storm_req)
{
    int i = 0;
...
int storm_get_cpr_by_surl(struct srm_dbfd *dbfd,
                      char *r_token,
                      char *surl,
                      struct storm_copy_filereq *cpr_entry,
                      int lock,
...
int storm_get_cpr_by_surls(struct srm_dbfd *dbfd,
                       char *r_token,
                       char *from_surl,
                       char *to_surl,
                       struct storm_copy_filereq *cpr_entry,
...
int storm_get_gfr_by_surl(struct srm_dbfd *dbfd,
                          char *r_token,
                          char *from_surl,
...
int storm_get_pending_req_by_token(struct srm_dbfd *dbfd, char *r_token, struct storm_req *storm_req,
                                   int lock, storm_dbrec_addr *rec_addr)
{
...
int storm_get_pfr_by_surl(struct srm_dbfd *dbfd,
                          char *r_token,
                          char *to_surl,
                          struct storm_put_filereq *pfr_entry,
                          int lock,
...
int storm_get_req_by_token(struct srm_dbfd *dbfd, char *r_token, struct storm_req *storm_req,
                           int lock, storm_dbrec_addr *rec_addr)
{
...
int storm_insert_cpr_entry(struct srm_dbfd *dbfd,
                       struct storm_copy_filereq *cpr_entry)
{
...
*/
int storm_insert_gfr_entry(struct srm_dbfd *dbfd, 
                           struct storm_get_filereq *gfr_entry, 
...
int storm_insert_gfr_entry_array(struct srm_dbfd *dbfd, 
...
*/
    ...
    *gfr_array_ptr = calloc(size+1 , sizeof(struct storm_get_filereq *));
    ...
    for (i = 0; NULL != (row = mysql_fetch_row(res)); i++){
        ...
        gfr_array[i] = calloc(1,sizeof(struct storm_get_filereq));
        if(NULL == gfr_array[i]){
            free_gfr_entry_array(gfr_array);
            return ENOMEM;
        }
 ...
 */
int storm_get_gfr_status(struct srm_dbfd *dbfd,
...
*/
storm_id_t storm_insert_pending_entry(struct srm_dbfd *dbfd, 
...
int storm_insert_pfr_entry(struct srm_dbfd *dbfd, struct storm_put_filereq *pfr_entry)
{
...
int storm_insert_xferreq_entry(struct srm_dbfd *dbfd, struct storm_req *storm_req)
{
...
int storm_list_cpr_entry(struct srm_dbfd *dbfd,
                     int bol,
                     char *r_token,
                     struct storm_copy_filereq *cpr_entry, 
                     int lock,
...
int storm_list_gfr_entry(struct srm_dbfd *dbfd,
                         int bol,
                         char *r_token,
                         struct storm_get_filereq *gfr_entry, 
                         int lock,
...
int storm_list_pending_req(struct srm_dbfd *dbfd,
                       int bol,
                       struct storm_req *storm_req, 
                       int lock,
                       storm_dbrec_addr *rec_addr,
...
storm_list_pfr_entry(struct srm_dbfd *dbfd, int bol, char *r_token, struct storm_put_filereq *pfr_entry, 
...
*/
int storm_list_protocol(struct srm_dbfd *dbfd,
                        char **protocol,
                        int nbprot,
                        int protlen,
                        storm_dbrec_addr *rec_addr)
