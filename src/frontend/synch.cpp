...
void register_request_error(const char* func_name, srm_request_status status, boost::posix_time::ptime start_time,std::string const& msg){
...
template<typename response_container_t, typename response_t, typename request_t, typename soap_request_t>
int handle_request(const char* func_name, struct soap* soap, soap_request_t* soap_req, response_container_t* response_container, response_t** soap_resp){
	...
	request_t* request;
	int soap_return_value = SOAP_OK;

	try{

		request = new request_t(soap, soap_req);

	}catch(storm::invalid_request& e){

		*soap_resp = storm::build_error_message_response<response_t>(
					soap,
	...
	bool request_is_blacklisted = true;

	try{

		request_is_blacklisted = storm::Authorization::checkBlacklist(request->getSoapRequest());
		...
		*soap_resp = storm::build_error_message_response<response_t>(
		...
		register_request_error<request_t>(func_name,
						SRM_USCOREFAILURE,
						start_time,
						str(format("Error authorizing request (Argus exception): %s\n") % e.what()));
	...
	soap_return_value = request->performXmlRpcCall(response_container);

	storm::MonitoringHelper::registerOperation(request->getStartTime(),
			soap_return_value,
...
int ns1__srmMkdir(struct soap* soap, struct ns1__srmMkdirRequest *req,
	...
	return handle_request<ns1__srmMkdirResponse_,ns1__srmMkdirResponse,storm::MkdirRequest,ns1__srmMkdirRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmRmdir(struct soap* soap, struct ns1__srmRmdirRequest *req,
	...
	return handle_request<ns1__srmRmdirResponse_,ns1__srmRmdirResponse,storm::RmdirRequest,ns1__srmRmdirRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmRm(struct soap* soap, struct ns1__srmRmRequest *req,
	...
	return handle_request<ns1__srmRmResponse_,ns1__srmRmResponse,storm::RmRequest,ns1__srmRmRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmLs(struct soap* soap, struct ns1__srmLsRequest *req,
	...
	return handle_request<ns1__srmLsResponse_,ns1__srmLsResponse,storm::LsRequest,ns1__srmLsRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmStatusOfLsRequest(struct soap* soap, struct ns1__srmStatusOfLsRequestRequest *req,
	...
	return handle_request<ns1__srmStatusOfLsRequestResponse_,ns1__srmStatusOfLsRequestResponse,storm::StatusLsRequest,ns1__srmStatusOfLsRequestRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmMv(struct soap* soap, struct ns1__srmMvRequest *req,
	...
	return handle_request<ns1__srmMvResponse_,ns1__srmMvResponse,storm::MvRequest,ns1__srmMvRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmSetPermission(struct soap* soap, struct ns1__srmSetPermissionRequest *req,
	...
	return handle_request<ns1__srmSetPermissionResponse_,ns1__srmSetPermissionResponse,storm::SetPermissionRequest,ns1__srmSetPermissionRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmCheckPermission(struct soap* soap, struct ns1__srmCheckPermissionRequest *req,
	...
	return handle_request<ns1__srmCheckPermissionResponse_,ns1__srmCheckPermissionResponse,storm::CheckPermissionRequest,ns1__srmCheckPermissionRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmGetPermission(struct soap* soap, struct ns1__srmGetPermissionRequest *req,
	...
	return handle_request<ns1__srmGetPermissionResponse_,ns1__srmGetPermissionResponse,storm::GetPermissionRequest,ns1__srmGetPermissionRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmReserveSpace(struct soap* soap, struct ns1__srmReserveSpaceRequest *req,
	...
	return handle_request<ns1__srmReserveSpaceResponse_,ns1__srmReserveSpaceResponse,storm::ReserveSpaceRequest,ns1__srmReserveSpaceRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmStatusOfReserveSpaceRequest(struct soap* soap, struct ns1__srmStatusOfReserveSpaceRequestRequest *req,
	...
	return handle_request<ns1__srmStatusOfReserveSpaceRequestResponse_,ns1__srmStatusOfReserveSpaceRequestResponse,storm::StatusReserveSpaceRequest,ns1__srmStatusOfReserveSpaceRequestRequest>(
		funcName,
		soap,
		req,
		rep,
 		&(rep->srmStatusOfReserveSpaceRequestResponse));
...
int ns1__srmReleaseSpace(struct soap* soap, struct ns1__srmReleaseSpaceRequest *req,
	...
	return handle_request<ns1__srmReleaseSpaceResponse_,ns1__srmReleaseSpaceResponse,storm::ReleaseSpaceRequest,ns1__srmReleaseSpaceRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmUpdateSpace(struct soap* soap, struct ns1__srmUpdateSpaceRequest *req,
	...
	return handle_request<ns1__srmUpdateSpaceResponse_,ns1__srmUpdateSpaceResponse,storm::UpdateSpaceRequest,ns1__srmUpdateSpaceRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmStatusOfUpdateSpaceRequest(struct soap* soap, struct ns1__srmStatusOfUpdateSpaceRequestRequest *req,
	...
	return handle_request<ns1__srmStatusOfUpdateSpaceRequestResponse_,ns1__srmStatusOfUpdateSpaceRequestResponse,storm::StatusUpdateSpaceRequest,ns1__srmStatusOfUpdateSpaceRequestRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmGetSpaceMetaData(struct soap* soap, struct ns1__srmGetSpaceMetaDataRequest *req,
	...
	return handle_request<ns1__srmGetSpaceMetaDataResponse_,ns1__srmGetSpaceMetaDataResponse,storm::GetSpaceMetaDataRequest,ns1__srmGetSpaceMetaDataRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmGetSpaceTokens(struct soap* soap, struct ns1__srmGetSpaceTokensRequest *req,
	...
	return handle_request<ns1__srmGetSpaceTokensResponse_,ns1__srmGetSpaceTokensResponse,storm::GetSpaceTokensRequest,ns1__srmGetSpaceTokensRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmChangeSpaceForFiles(struct soap* soap, struct ns1__srmChangeSpaceForFilesRequest *req,
	...
	return handle_request<ns1__srmChangeSpaceForFilesResponse_,ns1__srmChangeSpaceForFilesResponse,storm::ChangeSpaceForFilesRequest,ns1__srmChangeSpaceForFilesRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmStatusOfChangeSpaceForFilesRequest(struct soap* soap, struct ns1__srmStatusOfChangeSpaceForFilesRequestRequest *req,
	...
	return handle_request<ns1__srmStatusOfChangeSpaceForFilesRequestResponse_,ns1__srmStatusOfChangeSpaceForFilesRequestResponse,storm::StatusChangeSpaceForFilesRequest,ns1__srmStatusOfChangeSpaceForFilesRequestRequest>(
		funcName,
		soap,
		req,
		rep,
 		&(rep->srmStatusOfChangeSpaceForFilesRequestResponse));
}
...
int ns1__srmExtendFileLifeTimeInSpace(struct soap* soap, struct ns1__srmExtendFileLifeTimeInSpaceRequest *req,
	...
	return handle_request<ns1__srmExtendFileLifeTimeInSpaceResponse_,ns1__srmExtendFileLifeTimeInSpaceResponse,storm::ExtendFileLifeTimeInSpaceRequest,ns1__srmExtendFileLifeTimeInSpaceRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmPurgeFromSpace(struct soap* soap, struct ns1__srmPurgeFromSpaceRequest *req,
	...
	return handle_request<ns1__srmPurgeFromSpaceResponse_,ns1__srmPurgeFromSpaceResponse,storm::PurgeFromSpaceRequest,ns1__srmPurgeFromSpaceRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmReleaseFiles(struct soap* soap, struct ns1__srmReleaseFilesRequest *req,
	...
	return handle_request<ns1__srmReleaseFilesResponse_,ns1__srmReleaseFilesResponse,storm::ReleaseFilesRequest,ns1__srmReleaseFilesRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmPutDone(struct soap* soap, struct ns1__srmPutDoneRequest *req,
	...
	return handle_request<ns1__srmPutDoneResponse_,ns1__srmPutDoneResponse,storm::PutDoneRequest,ns1__srmPutDoneRequest>(
		funcName,
		soap,
		req,
		rep,
 		&(rep->srmPutDoneResponse));
}
...
int ns1__srmAbortRequest(struct soap* soap, struct ns1__srmAbortRequestRequest *req,
	...
	return handle_request<ns1__srmAbortRequestResponse_,ns1__srmAbortRequestResponse,storm::AbortRequestRequest,ns1__srmAbortRequestRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmAbortFiles(struct soap* soap, struct ns1__srmAbortFilesRequest *req,
	...
	return handle_request<ns1__srmAbortFilesResponse_,ns1__srmAbortFilesResponse,storm::AbortFilesRequest,ns1__srmAbortFilesRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmSuspendRequest(struct soap* soap, struct ns1__srmSuspendRequestRequest *req,
	...
	return handle_request<ns1__srmSuspendRequestResponse_,ns1__srmSuspendRequestResponse,storm::SuspendRequestRequest,ns1__srmSuspendRequestRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmResumeRequest(struct soap* soap, struct ns1__srmResumeRequestRequest *req,
	...
	return handle_request<ns1__srmResumeRequestResponse_,ns1__srmResumeRequestResponse,storm::ResumeRequestRequest,ns1__srmResumeRequestRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmExtendFileLifeTime(struct soap* soap, struct ns1__srmExtendFileLifeTimeRequest *req,
	...
	return handle_request<ns1__srmExtendFileLifeTimeResponse_,ns1__srmExtendFileLifeTimeResponse,storm::ExtendFileLifeTimeRequest,ns1__srmExtendFileLifeTimeRequest>(
		funcName,
		soap,
		req,
		rep,
 		&(rep->srmExtendFileLifeTimeResponse));
}
...
int ns1__srmGetTransferProtocols(struct soap* soap, struct ns1__srmGetTransferProtocolsRequest *req,
	...
	return handle_request<ns1__srmGetTransferProtocolsResponse_,ns1__srmGetTransferProtocolsResponse,storm::GetTransferProtocolsRequest,ns1__srmGetTransferProtocolsRequest>(
		funcName,
		soap,
		req,
		rep,
...
int ns1__srmPing(struct soap* soap, struct ns1__srmPingRequest *req,
	...
	return handle_request<ns1__srmPingResponse_,ns1__srmPingResponse,storm::PingRequest,ns1__srmPingRequest>(
		funcName,
		soap,
		req,
		rep,
