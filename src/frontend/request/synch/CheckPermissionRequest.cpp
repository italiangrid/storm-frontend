...
void storm::CheckPermissionRequest::load(ns1__srmCheckPermissionRequest* request) throw (storm::invalid_request)
{
...
void storm::CheckPermissionRequest::buildResponse() throw (std::logic_error, storm::InvalidResponse)
{
