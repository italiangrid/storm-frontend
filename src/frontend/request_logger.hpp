...
template <typename T>
void log_debug_information(const char* func, T & request){
...
void simple_logger(const char* func, T & request) {
	log_debug_information(func,request);
...
struct logging_traits<storm::CheckPermissionRequest>{
	void log_request(const char* func, storm::CheckPermissionRequest & request) {
		surl_logger(func, request);
	}
};
...
struct logging_traits<storm::StatusReserveSpaceRequest>{
	void log_request(const char* func, storm::StatusReserveSpaceRequest & request) {
		surl_req_token_logger(func,request);
	}
};
...
struct logging_traits<storm::StatusUpdateSpaceRequest>{
	void log_request(const char* func, storm::StatusUpdateSpaceRequest& request) {
		surl_req_token_logger(func,request);
	}
};
...
struct logging_traits<storm::StatusChangeSpaceForFilesRequest>{
	void log_request(const char* func, storm::StatusChangeSpaceForFilesRequest& request) {
		surl_req_token_logger(func,request);
	}
};
...
struct logging_traits<storm::ExtendFileLifeTimeRequest>{
	void log_request(const char* func, storm::ExtendFileLifeTimeRequest& request) {
...
struct logging_traits<storm::GetSpaceMetaDataRequest>{
	void log_request(const char* func, storm::GetSpaceMetaDataRequest& request) {
...
struct logging_traits<storm::ExtendFileLifeTimeInSpaceRequest>{
	void log_request(const char* func, storm::ExtendFileLifeTimeInSpaceRequest& request) {
		surl_space_token_logger(func,request);
	}
};
...
struct logging_traits<storm::ChangeSpaceForFilesRequest>{
	void log_request(const char* func, storm::ChangeSpaceForFilesRequest& request) {
