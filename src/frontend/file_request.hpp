...
namespace storm {
    ...
    class file_request {
    public:
        file_request(struct soap *soap) : _credentials(soap), _soap(soap) {};
        ...
        void setClientDN(const char* clientDN) { _credentials.setDN(std::string(clientDN)); };
        
        bool saveProxy() { _credentials.saveProxy(_r_token); };
        ...
        */
        ...
        std::vector<sql_string> getFQANsVector() { return _credentials.getFQANsVector(); };
        
        

        char overwrite(){return _overwrite;};
        char overwrite(char o){char old=_overwrite,_overwrite=o;return old;};
