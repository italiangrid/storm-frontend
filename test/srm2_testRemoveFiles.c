...
//	int r = 0;
//	char *r_token;
//	struct ns1__srmRemoveFilesResponse_ rep;
//	struct ArrayOfTSURLReturnStatus *repfs;
//	struct ns1__srmRemoveFilesRequest req;
...
//	req.siteURLs->__size = nbfiles;
//
//	for (i = 0; i < nbfiles; i++) {
//		reqfilep = req.siteURLs->__ptr[i];
//		reqfilep->value = argv[i+2];
//	}
//
//	if (soap_call_ns1__srmRemoveFiles (&soap, srm_endpoint, "RemoveFiles",
//	    &req, &rep)) {
...
//		exit (1);
//	}
//	reqstatp = rep.srmRemoveFilesResponse->returnStatus;
//	repfs = rep.srmRemoveFilesResponse->arrayOfFileStatuses;
//
