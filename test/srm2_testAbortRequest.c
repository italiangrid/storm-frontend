...
//
//	if (argc < 3) {
//		fprintf (stderr, "usage: %s endPoint reqid\n", argv[0]);
//		exit (1);
//	}
//	//nbfiles = argc - 2;
//
...
//	}
//
//	req.requestToken->value = argv[2];
//
//	//if (soap_call_ns1__srmAbortRequest (&soap, srm_endpoint, "AbortRequest",
//	if (soap_call_ns1__srmAbortRequest (&soap, argv[1], "AbortRequest",
//	    &req, &rep)) {
